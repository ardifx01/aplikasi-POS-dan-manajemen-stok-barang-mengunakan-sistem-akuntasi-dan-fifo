                        ...
                        <form action="{{ route('pembelian.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="kategori" id="kategori" class="form-control"  class="form-select" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="satuan" id="satuan" class="form-control" class="form-select" required>
